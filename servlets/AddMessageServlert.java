...
/**
 * Servlet that add a message to the messages table
 */
@WebServlet("/AddMessageServlert")
public class AddMessageServlert extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public AddMessageServlert() {
		super();
	 ...
	 *      response)
	 * @see servlet that insert a message to the messages table
...
//		SimpleDateFormat sdf = new SimpleDateFormat("MM/dd/yyyy h:mm:ss a");
		...
		try {
			...
			try {
				...
				message = "ADDING_MESSAGE_SUCCESS";
